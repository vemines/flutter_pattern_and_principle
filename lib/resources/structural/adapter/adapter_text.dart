const List<String> definition = [
  "The Adapter pattern allows objects with incompatible interfaces to work together. It converts the interface of one object (the adaptee) into an interface that the client expects."
];
