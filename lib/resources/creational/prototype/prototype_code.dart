const String prototypeCode = """class PrototypeClass {
  ...
  PrototypeClass clone() {
    return PrototypeClass(header, body);
  }

  PrototypeClass copyWith({String? headerData, String? bodyData}) {
    return PrototypeClass(headerData ?? header, bodyData ?? body);
  }
}
...
void main(List<String> args) {
  ...
  PrototypeClass copyWith =      prototype.copyWith(headerData: "header2", bodyData: "body2");
}""";
